class Calculator {
constructor(answerTextElement, workspaceTextElement) {
    ...
    updateDisplay() {
        ...
        if(this.operator != null) {
            this.answerTextElement.innerText = 
...
const calculator = new Calculator(answerTextElement, workspaceTextElement)
